...
Analytics page shows (backend/app/routes/analytics.py) - and fills the markers in
    ...
    README.md, docs/DECK_CONTENT.md, docs/VIDEO_SCRIPT.md, docs/DEVPOST_SUBMISSION.md
    (from the repository root; a missing file is skipped with a warning)
...
DOCUMENTS = ("README.md", "docs/DECK_CONTENT.md", "docs/VIDEO_SCRIPT.md", "docs/DEVPOST_SUBMISSION.md")   # from the repository root
